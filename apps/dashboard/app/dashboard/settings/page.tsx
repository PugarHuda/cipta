...
<img src="https://cipta-demo-production.up.railway.app/api/pixel/${wallet || "0xYOUR_WALLET"}"
     width="1" height="1" alt=""
     style="position:absolute;opacity:0;pointer-events:none" />

<!-- Beacon script -->
<script>
  fetch("https://cipta-demo-production.up.railway.app/api/beacon", {
    method: "POST",
...
export async function middleware(req: NextRequest) {
  const res = await fetch("https://cipta-demo-production.up.railway.app/verify", {
    method: "POST",
    headers: {
